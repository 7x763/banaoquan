<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="index.php"><img src="upload/logo_khatoco.png" alt=""></a>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="index.php"><img style="max-height: 30px;" src="upload/logo_khatoco.png" alt=""></a>
                    </div>
                </div>
                        ...
                        <?php if(isset($_SESSION['user'])) { ?>
                            <div class="header__right__auth acount">
                                ...
                                <?php if(isset($_SESSION['user']['role']) && $_SESSION['user']['role'] == 1) { ?>
                                    <a href="admin/index.php" style="color: red; font-weight: bold; margin-left: 10px;">
                                        [QUẢN TRỊ]
                                    </a>
                                <?php } ?>
                            </div>
