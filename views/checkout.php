...
try {    
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["checkout"])) {
        ...
        // Bước 1 & 2: Insert dữ liệu và lấy order_id
        $order_id = $OrderModel->insert_orders($user_id, $total, $address, $phone, $note);
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="checkout__form__input">
                                ...
                                <input disabled type="text" value="<?= $_SESSION['user']['phone'] ?>">
                        ...
                        <div class="checkout__order__product">
                            <ul>
                                ...
                                <?php
                                    ...
                                    ?>
                                <!-- Thông tin insert vào orders (Gửi 1 lần duy nhất) -->
